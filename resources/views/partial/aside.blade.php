<aside id="sidebar"
    ...
    <nav class="mt-8 space-y-2 p-4 h-[80vh] overflow-y-scroll [scrollbar-width:none] [-ms-overflow-style:none]">
        ...
        <a href="/konten" @class([
            ...
            <span class="nav-text ml-3 whitespace-nowrap">Konten</span>
            <span
                class="absolute left-full ml-3 px-3 py-1 bg-gray-700 text-xs rounded-md whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200 z-50 md:hidden sidebar-tooltip">Haji
                Konten</span>
        </a>
        ...
        <a href="/gift" @class([
            ...
            <span class="nav-text ml-3 whitespace-nowrap">Gift</span>
            <span
                class="absolute left-full ml-3 px-3 py-1 bg-gray-700 text-xs rounded-md whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200 z-50 md:hidden sidebar-tooltip">Gift</span>
        </a>
