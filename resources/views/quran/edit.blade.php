    ...
    <body class="bg-gray-50 flex h-screen overflow-hidden">
        ...
        <script>
            ...
            $('#addAudio').click(function() {
                var html = `<div class="flex justify-between my-2 audio-item">
                                <input type="text" name="audio_full[]" id="arti_english"
                                    class="bg-gray-50 border border-gray-300 focus:border-primary-600 dark:border-gray-600 dark:focus:border-blue-500 text-gray-900 rounded-lg focus:ring-primary-600 block w-full p-2.5 dark:bg-white-100 dark:placeholder-gray-400 dark:text-gray dark:focus:ring-blue-500 w-[80%]"
                                    value="" placeholder="Pengertian Haji Umroh" />
                                <div class="flex w-[10%] justify-end">
                                    <button type="button" data-id="null" data-url="null"
                                        class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center me-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800 my-auto remove-audio">
                                        <i class="ri-delete-bin-6-fill"></i>
                                        <span class="sr-only">Icon description</span>
                                    </button>
