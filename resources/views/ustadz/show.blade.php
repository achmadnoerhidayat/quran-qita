            ...
            <main class="p-4 md:p-8 flex-1">
                <div
                    ...
                    <div class="flex justify-between mb-2">
                        ...
                        <p class="text-gray-900 dark:text-white ">
                            Rp {{ number_format($data->plan->price, 0, ',', '.') }}
                        </p>
                    </div>
                    <div class="flex justify-between mb-2">
                        <p class="text-gray-900 dark:text-white ">
                ...
                <div
                    ...
                    <div class="flex justify-between mb-2">
                        ...
                        <p class="text-gray-900 dark:text-white ">
                            {{ !empty($data->starts_at) ? $data->starts_at->format('d M Y H:i') : '' }}
                        </p>
                    </div>
                    <div class="flex justify-between mb-2">
                        <p class="text-gray-900 dark:text-white ">
                        ...
                        <p class="text-gray-900 dark:text-white ">
                            {{ !empty($data->end_at) ? $data->end_at->format('d M Y H:i') : '' }}
                        </p>
                    </div>
                    <div class="flex justify-between mb-2">
                        <p class="text-gray-900 dark:text-white ">
                        ...
                        <p class="text-gray-900 dark:text-white ">
                            @if ($data->payment_status === 'paid')
                                <span
                                    class="bg-green-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">{{ $data->payment_status }}</span>
                            @else
                                <span
                                    class="bg-yellow-100 text-yellow-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-full dark:bg-yellow-900 dark:text-yellow-300">{{ $data->payment_status }}</span>
                            @endif
                        </p>
                    </div>
                    <div class="flex justify-between mb-2">
