...
@section('content')
    ...
    <body class="bg-gray-50 flex h-screen overflow-hidden">
                        ...
                        <tbody>
                            @foreach ($data as $news)
                                <tr class="bg-white border-b border-gray-200">
                                    ...
                                    <td class="px-6 py-4">
                                        {{ \Illuminate\Support\Str::limit(strip_tags($news->body), 25) }}
                                    </td>
                                    <td class="px-6 py-4">
        ...
        <x-modal>
            ...
            <form class="space-y-4 md:space-y-6 mt-3" method="POST" action="{{ route('store-lesson') }}">
                @csrf
                <div>
                    <label for="role"
                ...
                <div>
                    <label for="body" class="block mb-2 text-sm font-medium text-black-100 dark:text-black">Body</label>
                ...
                <div>
                    <label for="content_url" class="block mb-2 text-sm font-medium text-black-100 dark:text-black">Content
                        Url</label>
                    <input type="content_url" name="content_url" id="content_url"
                        ...
                        value="{{ old('content_url') }}" placeholder="Masukan content_url ...." />
                    @error('content_url')
                        <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                    @enderror
                </div>
