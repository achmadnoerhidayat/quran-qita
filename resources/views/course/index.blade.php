...
@section('content')
    ...
    <body class="bg-gray-50 flex h-screen overflow-hidden">
        ...
        <div id="main-content" class="flex-1 flex flex-col overflow-y-auto overflow-x-hidden">
            ...
            <header class="sticky top-0 bg-white shadow-md p-4 md:p-6 flex justify-between items-center z-40">
                ...
                <div class="flex items-center">
                    ...
                    <h2 class="text-xl font-bold text-gray-800 ml-4 hidden sm:block">Dashboard Course</h2>
                </div>
                                ...
                                <tr class="bg-white border-b border-gray-200">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex justify-content-center">
                                            <a href="/course/edit/{{ $news->id }}" class="text-[18px] mx-2">
        ...
        <x-modal>
            <h2 class="text-lg font-bold mb-4 text-red-600">Tambah Kursus Ngaji</h2>
            <form class="space-y-4 md:space-y-6 mt-3" method="POST" action="{{ route('store-course') }}">
                @csrf
                <div>
                    <label for="title"
